...
for (i in 1: length(termS)){
 yy_high_count<- YY_high[which(YY_high$term==termS[i]),][2]
  yy_low_count<- YY_low[which(YY_low$term==termS[i]),][2]
  yy_high_table<- as.data.table(yy_high_count)
  yy_low_table<- as.data.table(yy_low_count)
  tableYY<- cbind(yy_high_table,yy_low_table)
}
